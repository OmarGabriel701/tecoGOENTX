    ...
    <div class="container-fluid bg-3 text-center">    
      ...
      <div class="row">
        <div class="col-sm-4">
            ...
            <?php
        $user = $_POST['username'];
         echo "<p class='text-center'><strong>".$user."</strong></p>";
        ...
        echo "<img src='".$id.".jpg'  class='img-circle person' alt='Random Name' width='255' height='255'>"; 
        ?>
          <!--  <img src="enigma.jpg" class="img-circle person" alt="Random Name" width="255" height="255">-->
          </a>
          <div>
            <br>
            <p>- Ciclista de Pista</p>
          </div>
        </div>  
        <div class="col-sm-4"> 
          <p>Renta tu equipo</p>
              <img src="usbi.jpg" class="img-responsive margin" style="width:100%" alt="Image" a href="tabla.php">
              <center><button type="submit" class="btn btn-block">Entrar </button>
          </form>
        </div>
        <div class="col-sm-4"> 
